...
object BackupUtils {
    ...
    fun FragmentActivity.backupGithub(){
        ...
        val gistId = githubApi.getLatestLoginData()?.server ?: throw IllegalArgumentException("Requires Gist Id")
        val token = githubApi.getLatestLoginData()?.password ?: throw IllegalArgumentException("Requires Token")
